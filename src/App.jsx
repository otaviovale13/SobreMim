  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <div className={styles.paiMain}>
          ...
          <div className={styles.iconsMain}>
            <i class="bi bi-linkedin bi-main"></i>
            <i class="bi bi-github bi-main"></i>
            <i class="bi bi-envelope bi-main"></i>
          </div>
        </div>
        <img
      ...
      <div className={styles.projetos}>
        ...
        <div className={styles.projetosMain}>
          <div className={styles.projeto}>
            ...
            <p className={styles.descricao}>Um site de uma Hamburgueria de Itupeva</p>
            <a className={styles.link} href="https://otaviovale13.github.io/mix-burguer-front/index.html" target="black">Ver Projeto</a>
          </div>
          <div className={styles.projeto}>
      ...
      <div className={styles.sobreMim}>
        ...
        <p className={styles.sobreMimTexto}>
          Até o momento não tenho experiência profissional, mas estou
          estudando, me dedicando e focando para conseguir minha primeira
          oportunidade de emprego. Como estou estudando no periodo da tarde, 
          estou disponível para trabalho no periodo da manhã, entro no curso 
          ás 13h:30m, procuro um estágio e um trabalho HomeOffice que seja
          no periodo de Manhã e que posso sair para chegar a tempo no meu
          curso.
        </p>
      </div>
      <Footer />
